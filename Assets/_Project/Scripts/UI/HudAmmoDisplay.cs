...
/// <summary>Показывает на HUD патроны оружия, которое игрок держит в руке. Повесить на объект с TextMeshProUGUI.</summary>
public class HudAmmoDisplay : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        string text = gun == null ? emptyHandsText : $"{Mathf.Max(0, (int)gun.currentAmmo)} / {(int)gun.maxAmmo}";
