...
public static class StaticHolder
{
    ...
    public static bool GameOver = false;   // победа: показать экран End в меню (только в памяти, не сохраняется)
    public static bool PlayerLost = false; // поражение: показать экран Defeat в меню (только в памяти, не сохраняется)
    ...
    // Сброс всего состояния забега (прокачка, оружие, импланты). Вызывается при смерти, победе и выходе в меню.
